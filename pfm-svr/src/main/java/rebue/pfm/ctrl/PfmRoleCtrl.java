...
public class PfmRoleCtrl {
     ...
     * @mbg.generated
     */
    private final static Logger _log = LoggerFactory.getLogger(PfmRoleCtrl.class);
     ...
     */
    @GetMapping("/pfm/role")
    PageInfo<PfmRoleMo> list(PfmRoleMo mo, @RequestParam("pageNum") int pageNum, @RequestParam("pageSize") int pageSize) {
        _log.info("list PfmRoleMo:" + mo + ", pageNum = " + pageNum + ", pageSize = " + pageSize);
        if (pageSize > 50) {
            String msg = "pageSize不能大于50";
            _log.error(msg);
            throw new IllegalArgumentException(msg);
        }
        PageInfo<PfmRoleMo> result = svc.list(mo, pageNum, pageSize);
